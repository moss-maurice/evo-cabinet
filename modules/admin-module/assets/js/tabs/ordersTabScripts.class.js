class OrdersTabScripts {
    ...
    initOrderSearchHook() {
        jQuery(document)
            .on("change", "#ol-searchStatus", function (e) {
                ...
                var pageDomObject = moduleObject
                    .getMainDomObject()
                    .find(".tab-page")
                    .filter("#tab_" + tabName);
                var data = {
    ...
    initOrderListHook() {
        jQuery(document).on("click", ".removeOrder", function () {
            var tabName = jQuery(this).attr("rel-tab");
            var methodName = jQuery(this).attr("rel-tab-method");
            var pageDomObject = moduleObject
                .getMainDomObject()
        ...
        jQuery(document)
            ...
            .on("click", ".lk-module-order-save-button", function () {
                ...
                var data = {
                    ...
                    status_id: moduleObject
                        .getMainDomObject()
                        .find("#order-item")
                        .find("select#status-id")
            ...
            .on("click", ".lk-module-transaction-add-button", function () {
                ...
                var data = {
                    ...
                    transactionType: moduleObject.getMainDomObject().find("input.transaction-type:checked").val(),
    ...
    initOrderPersonSaveButtonsHook() {
        jQuery(document).on("click", ".modx-evo-lk-admin #actions .lk-module-person-save-button", function (event) {
            event.preventDefault();
    ...
    initOrderMailsTestHook() {
        jQuery(document).on("click", ".modx-evo-lk-admin .lk-module-send-mails-button", function (event) {
            event.preventDefault();
