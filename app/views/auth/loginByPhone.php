        ...
        <div class="cab-login">
            ...
            <form class="form-signin" method="POST" @submit.prevent="login">
                ...
                <div class="cab-login-input">
                    <label class="mb-1 d-block" for="login-phone">Номер телефона <small>(login)</small> <span class="red">*</span></label>
                    <input type="tel" name="mobile-phone" id="login-phone" required ref="loginphone" v-model="phone" v-focus />
                </div>
    ...
    <div v-show="authForm=='reg'">
        ...
        <div class="cab-login">
            ...
            <form class="form-signin" method="POST" @submit.prevent="preRegistration">
                ...
                <div class="cab-login-input">
                    <label for="reg-tel">Номер мобильного телефона <small>(login)</small><span class="red">*</span></label>
                    <input class="form-control" type="tel" name="mobile-phone" id="reg-tel" required v-focus ref="regphone" v-model="phone">
                </div>
    ...
    <div v-show="authForm=='checkCode'">
        <div class="cab-login">
            ...
            <form class="form-signin" method="POST" @submit.prevent="registration">
                <h1 class="h1 text-center">Подтверждение телефона</h1>

                <div class="cab-login-input text-center">
                    <label for="code" class="mb-1 d-block">Введите полученный код из email / cмс <span class="red">*</span></label>
                ...
                <div class="cab-reg-button">
                    <button class="btn btn-block btn-success" type="submit" :disabled="isCheckDisabled">ОК</button>
                </div>
    ...
    <div v-show="authForm=='remind'">
        <div class="cab-login">
            ...
            <form class="form-signin" method="POST" @submit.prevent>
                ...
                <div class="cab-login-input">
                    <label for="remind-phone">Номер мобильного телефона <small>(login)</small></label>
                    <input class="form-control" type="tel" name="remind-phone" id="remind-phone" v-focus ref="remindphone" v-model="phone">
                </div>
                ...
                <div class="cab-reg-button">
                    <button class="btn btn-block btn-outline-success" type="submit" :disabled="isRemindDisabled" @click="remind('sms')">Выслать пароль по SMS</button>
                </div>
